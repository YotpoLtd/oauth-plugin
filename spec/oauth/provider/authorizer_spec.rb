...
describe OAuth::Provider::Authorizer do
  ...
  describe "Authorization code" do
    ...
    describe "should issue code" do
      ...
      before(:each) do
        ...
        ::Account.should_receive(:find_by_key!).with('client id').and_return(@app)
      end

      it "should allow" do
        ::Oauth2Verifier.should_receive(:create!).with( :account=>@app,
                                                  :user=>@user,
  ...
  describe "Implict Grant" do
    ...
    describe "should issue token" do
      ...
      it "should allow" do
        ::Oauth2Token.should_receive(:create!).with( :account=>@app,
                                                  :user=>@user,
                                                  :callback_url=>'http://mysite.com/callback',
