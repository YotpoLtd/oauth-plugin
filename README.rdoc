...
You could add application specific information to the OauthToken and Account model for such things as object level access control, billing, expiry etc. Be creative and you can create some really cool applications here.
